...
```{r examples-clean_dir_name, message=FALSE}
...
```{r examples-compare_df, message=FALSE}
...
```{r examples-merge_note_obs, message=FALSE}
f <- system.file("uon-trial-1.csv", package = "pbwrangler")
df <- read_workbooks(dir=NULL, file_to_read = f)[[1]]
...
Create a meta-data to accompany filebooks.
...
```{r examples-create_meta_file, message=FALSE}
f <- system.file("uon-trial-1.csv", package = "pbwrangler")
...
```{r examples-capture_location, message=FALSE}
...
Run data checks using and compute derived columns st4gi package
...
```{r examples-read_workbooks, message=FALSE}
f <- system.file("uon-trial-1.csv", package = "pbwrangler")
